            ...
            <div class="modal-body">
                <form id="add-user-form" method="POST" action="./add_SQL.php" class="p-2" novalidate>
                    ...
                    <div class="mb-3 d-grid">
                        <input type="submit" value="Add User" class="btn btn-primary" id="add-user-btn">
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="col-lg-12 d-flex justify-content-between align-items-center">
            ...
            <div>
                <button class="btn btn-success" type="button" data-bs-toggle="modal"
                    data-bs-target="#addNewUserModal">Add competent person</button>
            </div>
        </div>
    </div>
    <hr>
    <div style="font-size:0.9rem ;">
        <div class="container-fluid table-responsive">
            <table class="table table-striped table-hover table-bordered shadow ">
				...
				?>
                    <tr>
                        <th scope="row" class="text-center"> <?php echo $fetch['id'] ?></th>
                        <td>
                        ...
                        <td>
                            <div class="d-grid">
                                ...
                                data-bs-toggle="modal" data-bs-target="#update_modal<?php echo $fetch['id'] ;?>">Edit</button>
                                <a href="#" class="btn btn-danger btn-sm rounded-pill d-grid py-1 my-1">Delete</a>
                            </div>
                        </td>
                    </tr>
                    <?php
