                ...
                <table class="table table-bordered shadow">
                    ...
                    <tbody>
                     ...
                     if($count_competent_person_trash['number_competent_person_trash'] > 0){
                        foreach ($results_competent_person_trash as $result) {
            ...
            <div class="table-responsive">
                <table class="table table-bordered shadow">
                    ...
                    <tbody>
                        <?php
                     $number = 1;
                     if($count_competent_person_approval['number_competent_person_approval'] > 0){
                        foreach ($results_competent_person_approval as $result) {
                     
                    ?>
                        <tr id="refresh-approval<?php echo $result['id']?>">

                            <?php include './competent_person_input.php';?>
